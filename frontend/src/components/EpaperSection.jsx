...
const EPAPERS = {
  ...
  English: [
    { id: 'times_of_india',    name: 'Times of India',     mode: 'articles' },
    { id: 'hindustan_times',   name: 'Hindustan Times',    mode: 'articles' },
    { id: 'deccan_herald',     name: 'Deccan Herald',      mode: 'articles' },
    { id: 'economic_times',    name: 'Economic Times',     mode: 'articles' },
